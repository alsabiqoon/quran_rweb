    ...
    showDialog(
      ...
      builder: (_) {
        final double listHeight =
            items.isEmpty ? 0 : (items.length * 26.0).clamp(80.0, 260.0);
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Text(_lang == 'ar' ? "✅ انتهت المسابقة" : "✅ Round finished",
                ...
                Row(children: [
                  ...
                  Text(_lang == 'ar' ? "عدد الأسئلة: ${digits(total)}" : "Questions: ${digits(total)}",
                ...
                Row(children: [
                  ...
                  const SizedBox(width: 8),
                  Text(_lang == 'ar' ? "المدة: $elapsedStr" : "Time spent: $elapsedStr",
          ...
          actions: [
            TextButton(
              ...
              child:
                  Text(_lang == 'ar' ? "إغلاق" : "Close", style: const TextStyle(fontSize: 16)),
            ),
            TextButton(
              onPressed: () async {
                await _killAllAudioAndInvalidateRound();
